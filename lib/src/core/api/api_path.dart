...
class ApiPath {
  ...
  static final _baseUrl = isProduction
      ? 'https://api.ystfamily.com'
      : 'https://api-dev.ystfamily.com';
  ...
  static final banner = '$_v2/banner';
  ...
  static String orderHistory(int status, int limit, int offset) =>
      '$_v2/order/history/$status?limit=$limit&offset=$offset';
  ...
  static String notificationList(int limit, int offset) =>
      '$_v2/notification/list?limit=$limit&offset=$offset';
